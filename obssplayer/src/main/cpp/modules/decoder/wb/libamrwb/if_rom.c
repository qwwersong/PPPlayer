...
const Word16t Mode_7k[NBBITS_7k << 1] = {
...
const Word16t Mode_9k[NBBITS_9k << 1] = {
...
const Word16t Mode_12k[NBBITS_12k << 1] = {
...
const Word16t Mode_14k[NBBITS_14k << 1] = {
   0, 0x1, 1, 0x10, 1, 0x4, 14, 0x40,
   21, 0x40, 28, 0x40, 35, 0x40, 1, 0x2,
   1, 0x8, 1, 0x20, 8, 0x100, 8, 0x80,
   8, 0x40, 8, 0x20, 8, 0x10, 22, 0x100,
...
const Word16t Mode_16k[NBBITS_16k << 1] = {
   0, 0x1, 1, 0x10, 1, 0x4, 14, 0x40,
   21, 0x40, 28, 0x40, 35, 0x40, 1, 0x2,
   1, 0x8, 1, 0x20, 8, 0x100, 8, 0x80,
   8, 0x40, 8, 0x20, 8, 0x10, 22, 0x100,
...
const Word16t Mode_18k[NBBITS_18k << 1] = {
...
const Word16t Mode_20k[NBBITS_20k << 1] = {
   0, 0x1, 1, 0x10, 1, 0x4, 18, 0x40,
   29, 0x40, 40, 0x40, 51, 0x40, 1, 0x2,
   1, 0x8, 1, 0x20, 8, 0x100, 8, 0x80,
   8, 0x40, 8, 0x20, 8, 0x10, 30, 0x100,
...
const Word16t Mode_23k[NBBITS_23k << 1] = {
   0, 0x1, 1, 0x10, 1, 0x4, 18, 0x40,
   29, 0x40, 40, 0x40, 51, 0x40, 1, 0x2,
   1, 0x8, 1, 0x20, 8, 0x100, 8, 0x80,
   8, 0x40, 8, 0x20, 8, 0x10, 30, 0x100,
...
const Word16t Mode_24k[NBBITS_24k << 1] = {
   0, 0x1, 1, 0x10, 1, 0x4, 18, 0x40,
...
const Word16t Mode_DTX[NBBITS_SID << 1] = {
...
const Word16t dfh_M9k[PRMNO_9k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 29,
   3, 15, 7,
...
const Word16t dfh_M12k[PRMNO_12k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 58,
   1, 7, 63,
...
const Word16t dfh_M14k[PRMNO_14k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 58,
   1, 3847, 3845,
...
const Word16t dfh_M16k[PRMNO_16k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 58,
   1, 3847, 3845,
...
const Word16t dfh_M18k[PRMNO_18k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 58,
   1, 3, 2,
...
const Word16t dfh_M20k[PRMNO_20k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 58,
   1, 161, 759,
...
const Word16t dfh_M23k[PRMNO_23k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 58,
   1, 1154, 1729,
...
const Word16t dfh_M24k[PRMNO_24k] = {
   0, 49, 131,
   55, 49, 38,
   26, 29, 58,
   1, 1729, 1154,
