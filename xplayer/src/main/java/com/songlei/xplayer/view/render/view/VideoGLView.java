...
import com.songlei.xplayer.view.render.glrender.VideoGLViewSimpleRender;
import com.songlei.xplayer.view.render.listener.GLRenderErrorListener;
import com.songlei.xplayer.view.render.listener.GLSurfaceListener;
...
public class VideoGLView extends GLSurfaceView implements GLSurfaceListener, IRenderView, MeasureHelper.MeasureFormVideoParamsListener {
    ...
    public Bitmap initCover() {
        Log.e(TAG, "not support initCover now");
        return null;
    }

    @Override
    public Bitmap initCoverHigh() {
        Log.e(TAG, "not support initCoverHigh now");
        return null;
    }
...
//                    FileUtils.saveBitmap(bitmap, file);
    ...
    public void setRenderTransform(Matrix transform) {
        Log.e(TAG, "not support setRenderTransform now");
    }
