package com.songlei.xplayer.view.render.glrender;
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (mGLRenderErrorListener != null) {
                        mGLRenderErrorListener.onError(VideoGLViewBaseRender.this, op + ": glError " + error, error, mChangeProgramSupportError);
                    }
